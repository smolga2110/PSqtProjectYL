...
"}")
    ...
    def retranslateUi(self, SplashScreen):
        ...
        self.label_title.setText(QCoreApplication.translate("SplashScreen", u"<strong>ЗАГРУЗЧИК</strong> ВИДЕО", None))
        self.label_description.setText(QCoreApplication.translate("SplashScreen", u"<strong>APP</strong> ОПИСАНИЕ", None))
        self.label_loading.setText(QCoreApplication.translate("SplashScreen", u"загрузка...", None))
        self.label_credits.setText(QCoreApplication.translate("SplashScreen", u"<strong>Создал</strong>: Мазенин.А.А", None))
